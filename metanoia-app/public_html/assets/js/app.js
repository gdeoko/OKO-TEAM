...
const CHAT_MSGS = {
  ...
  4: { pinned: 'Пока школа работает без сервера, сообщения отсюда никуда не уходят: '
       + 'они остаются на этом устройстве. Срочный вопрос задайте Екатерине в Телеграме школы.',
    msgs: [
