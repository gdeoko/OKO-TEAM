...
const ICON_PATHS = {
  ...
  // Зерно: наклонённое пшеничное зёрнышко с прожилкой. Прежний рисунок
  // (овал на ножке) читался как микрофон, и «Покормить» выглядело странно.
  seed:    '<ellipse cx="12" cy="12" rx="4.6" ry="7.2" transform="rotate(35 12 12)"/><path d="M8.8 15.6c1.6-2.2 3.7-3.9 6.4-5.1"/>',
  sprout:  '<path d="M12 21v-9"/><path d="M12 12c0-3-2-5-6-5 0 4 3 6 6 5Z"/><path d="M12 14c0-3 2-4 6-4 0 3-3 5-6 4Z"/>',
  // Цветок и дерево: прежние рисунки на маленьком размере сливались в пятно
  // и в леденец на палочке. Ромашка из кружков и крона с ветками читаются.
  flower:  '<circle cx="12" cy="6.6" r="2.1"/><circle cx="8.6" cy="9.4" r="2.1"/><circle cx="15.4" cy="9.4" r="2.1"/><circle cx="12" cy="12.2" r="2.1"/><circle cx="12" cy="9.4" r="1.15"/><path d="M12 21v-6.4"/>',
  tree:    '<circle cx="12" cy="6.9" r="3.4"/><circle cx="8.2" cy="10.2" r="3"/><circle cx="15.8" cy="10.2" r="3"/><path d="M12 21.6v-8.2"/>',
  ...
  /* животные (игра «Ноев Ковчег») */
  fish:    '<path d="M3 12c3-4 8-6 12-6 3 0 5 2 5 6s-2 6-5 6c-4 0-9-2-12-6Z"/><path d="M20 6c1 2 1 10 0 12M8 9.5v5"/><circle cx="16" cy="10.5" r=".6" fill="currentColor"/>',
  turtle:  '<path d="M5 15a7 5 0 0 1 14 0Z"/><path d="M19 13c1.4-.3 2.5.2 2.5 1.2M5 13c-1.4-.3-2.5.2-2.5 1.2M8 18l-1 2.5M16 18l1 2.5"/><path d="M12 6a2 2 0 0 0-2 2M12 10v5M8.5 12.5 12 10l3.5 2.5"/>',
  rabbit:  '<path d="M9 8C8 5 7.5 2.5 9 2.5s1.5 3 1 5.5M15 8c1-3 1.5-5.5 0-5.5s-1.5 3-1 5.5"/><path d="M8 12a4 4 0 0 1 8 0c0 3-1.5 5-4 5s-4-2-4-5Z"/><circle cx="10.5" cy="12.5" r=".6" fill="currentColor"/><circle cx="13.5" cy="12.5" r=".6" fill="currentColor"/>',
  bird:    '<path d="M15 6.5a2 2 0 1 1 3.4 1.4c-.6.6-1.4 1-1.4 2.6 0 3-2.5 6-6 6-4 0-7-2.5-7-6l3 1c.5-2.5 2.5-5 5-5Z"/><path d="M16.5 8.5h.01M4 11.5 2 13"/>',
  butterfly:'<path d="M12 6v11"/><path d="M12 8C10 4 3 4 3.5 8.5 3 12 8 12 12 10M12 8c2-4 9-4 8.5.5.5 3.5-4.5 3.5-8.5 1.5M12 13c-1.5 4-8 4-8.5.5-.3 2.5 4 3 8.5.5M12 13c1.5 4 8 4 8.5.5.3 2.5-4 3-8.5.5"/>',
  snail:   '<path d="M14 18H6a3 3 0 0 1 0-6c1.5 0 2 1 2 2M8 14a5 5 0 1 0 5-5 3.5 3.5 0 0 0-3.5 3.5A2.2 2.2 0 0 0 12 14.5"/><path d="M14 8V5.5M17 8V6"/>',
};
