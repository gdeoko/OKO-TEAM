...
# Поднимает кадр до 1152x2048 — одно качество для всех и всегда, уже в
# цене работы. Сами модели рисуют в своём разрешении (у Qwen это
...
#
# Без него панель отдаёт родное разрешение: не сломается, но картинка
# будет мельче обещанной.
