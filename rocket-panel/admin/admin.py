...
function карта(в) {
  ...
  return `<div class="карта${есть}" data-k="${в.ключ}">
    ...
    <div class="тело">
      ...
      <p class="группа">Кнопка</p>
      ${поле("input", в.ключ, "название", "По-русски",
             в.название, в.название_по_умолчанию)}
      ${поле("input", в.ключ, "название_en", "In English",
             в.название_en, в.название_en_по_умолчанию)}
      <p class="группа">Что происходит</p>
      ${поле("area", в.ключ, "строка_рус", "По-русски — видит клиент",
             в.строка_рус, "коротко, 2–5 слов")}
      ${поле("area", в.ключ, "строка_eng", "In English — видит клиент",
             в.строка_eng, "коротко; пусто — покажем строку для модели")}
      ${поле("area", в.ключ, "строка", "Для модели — только English",
