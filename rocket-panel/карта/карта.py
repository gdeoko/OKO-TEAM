...
ПОТОЛОК_ЦЕНЫ = float(os.environ.get("AMBERRY_ПОТОЛОК", "2.00"))
...
ПРОСТОЙ_МИНУТ = int(os.environ.get("AMBERRY_ПРОСТОЙ", "20"))
...
БЮДЖЕТ_РУБ = float(os.environ.get("AMBERRY_БЮДЖЕТ_РУБ", "100000"))
КУРС = float(os.environ.get("AMBERRY_КУРС", "92"))     # как в pricing.py
