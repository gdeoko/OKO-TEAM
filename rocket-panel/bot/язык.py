...
странице каталога (`строка_рус` и `строка_eng`), потому что пишет их
он, а не код. Нет английской — на экране показывается английская
строка для модели: длинно, но честно, и лучше пустоты.
...
СЦЕНАРИИ_EN = {
    ...
    "sc_office": ("Office", "Desk, blinds, stripes of light"),
...
СТРОКИ = {
    ...
    "низ.баланс":   {"ru": "Баланс",     "en": "Balance"},
    "низ.работы":   {"ru": "Мои работы", "en": "My works"},
    ...
    "оп.пакеты": {"ru": "<b>Пакеты</b> — не сгорают никогда",
                  "en": "<b>Packs</b> — they never expire"},
    ...
    "оп.пакет_кнопка": {"ru": "{коинов} {символ} — {рублей} ₽",
                        "en": "{коинов} {символ} — {рублей} ₽"},
