...
РУБРИКА_ОСНОВЫ = {
    "Цифры цеха":            ("площадка", "сетка", "предмет"),
    "Цифры отрасли":         ("сетка", "диорама", "вырезка"),
    "Деньги цеха":           ("предмет", "студия", "метафора"),
    "Цена киловатта":        ("предмет", "сетка", "студия"),
    "Цена ошибки":           ("метафора", "предмет", "площадка"),
    "За что дают":           ("предмет", "вырезка", "сетка"),
    "Как выбирать":          ("площадка", "предмет", "диорама"),
    "Не снесут":             ("диорама", "метафора", "сетка"),
    "Сто производств":       ("площадка", "вырезка", "диорама"),
    "Кто стоит у станка":    ("площадка", "студия", "метафора"),
    "Кадры цеха":            ("площадка", "студия", "вырезка"),
    "Сколько отсюда ехать":  ("площадка", "сетка", "диорама"),
    "Стройка будущего":      ("площадка", "диорама", "вырезка"),
    "Промышленный город":    ("диорама", "сетка", "метафора"),
    "Площадки мира":         ("сетка", "диорама", "вырезка"),
    "Отрасль":               ("сетка", "вырезка", "студия"),
    "Рынок":                 ("сетка", "метафора", "предмет"),
    "Воронка":               ("предмет", "метафора", "студия"),
    "Событие":               ("площадка", "метафора", "студия"),
}

ПО_УМОЛЧАНИЮ = ("площадка", "студия", "вырезка", "сетка", "предмет", "метафора", "диорама")
