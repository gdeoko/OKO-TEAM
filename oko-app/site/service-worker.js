...
const CORE_ASSETS = [
  ...
  '/oko-signals.js',    /* сигналы удержания для ленты рекомендаций */
  '/oko-market.js',     /* биржа: каталог, карточка, размещение, мои объявления */
  '/oko-ai.js',         /* ОКО Ai: экран нейросети в вёрстке личного чата */
  '/oko-hq2.js',        /* штаб OKO (агенты, задачи, отчёты) + админка владельца */
  '/oko-social.js',     /* страницы сущностей, ролики 9:16/16:9, клубы и курсы */
  '/oko-academy2.js',   /* Академия: оглавление, закладки, поиск, офлайн-конспекты */
  '/oko-wallet2.js',    /* кошелёк и оплата: честные деньги, Lava.top, тарифы, чеки, QR */
  '/oko-settings2.js',  /* настройки и безопасность: честная защита аккаунта */
  '/oko-chat2.js',      /* чаты уровня Telegram: реакции, ветки, папки, мультивыбор */
  '/oko-onb2.js',       /* первый вход, знакомство, глобальный поиск, уведомления */
  '/oko-mini2.js',      /* игры и рулетка, партнёрка, реклама, документы и TON */
  '/oko-channels2.js',  /* каналы: каталог с поиском, честная статистика, управление */
  '/oko-calls.js',      /* звонки: личный, входящий, созвон; честно без сигналинга */
  '/oko-factory2.js',   /* контент-завод как честный трекер + настоящий разбор видео в браузере */
  '/oko-system2.js',    /* система роста из ответов анкеты + честные «Мои соцсети» */
  '/oko-a11y.js',       /* доступность: имена, фокус, роли, контраст, цели нажатия */
  '/offline.html',
  '/oko-manifest.json',
  '/oko-icon-192.png',
  '/oko-icon-512.png',
