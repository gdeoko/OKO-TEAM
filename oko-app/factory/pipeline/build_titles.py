...
TITLES=[
 {"lines":["ЗАПЧАСТИ","И ГАРАНТИЯ"],"accent":1,"start":1.6,"end":4.3,"y":720},
 {"lines":["ВОПРОС","ЗАКРЫТ"],"accent":1,"start":4.5,"end":7.15,"y":720},
 {"lines":["НАПИШИТЕ","ГОРОД И ЗАДАЧУ"],"accent":1,"start":30.9,"end":35.8,"y":1230},
]
