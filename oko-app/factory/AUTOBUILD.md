...
## АНАЛИЗ КОНКУРЕНТОВ 28.07 — форматы под добавление (analysis/competitors_2807.md)
Разбор 94 видео ниши (YouTube, quad/moto/hydro из Китая). Топ-вовлечение (ER 1.7–3% vs норма 0.5–1%):
...
- **ТОП-Х листикл** — вечнозелёный поисковый трафик.
ДОБАВИТЬ В МИКС (следующими роликами, дедуп тем сохраняем):
1. VS-ролик (виральный): «китайский квадро/мото против дорогого бренда — кто застрянет», инфографика цена/ТТХ, финал «зачем платить больше».
2. «Страх→совет» (польза): «5 вещей проверить перед покупкой китайского квадро», «почему ломается и как не попасть» — это наш оффер наизнанку (мы даём документы+гарантию+сервис). Макс. комментов.
3. ТОП-Х (польза): «ТОП-5 китайских эндуро для леса/рыбалки».
ВОРОНКА/ОПИСАНИЕ (правка по конкурентам): dieselcompany.pro — ПЕРВОЙ строкой описания (у топов ссылка вверху); теги обогатить БРЕНД+МОДЕЛЬ (kayo, cfmoto, sharmax-класс) + VS-ключи («дешёвый против дорогого», «какой внедорожник выбрать», «челлендж»).
Ретеншн-приёмы топов совпадают с нашим no-voice: «пройдёт или застрянет?», реальный экшн грязь/брод/прыжок без диктора.

## АНАЛИЗ КОНКУРЕНТОВ #2 28.07 — короткий формат = ЗВУК + листиклы (analysis/competitors2_2807.md)
Свежие 93 видео (новые запросы, фокус Shorts). Открытия:
1. **ЗВУК двигателя = #1 виральный короткий формат мото** (BMW S1000RR Akrapovic 26М, Ninja H2R 4.6М, «звук мечты» клипы). БЛОКЕР: у нас no-voice на музыке, реального звука выхлопа наших байков нет. → нужен реальный звук-клип от Даниэля (снять у мотора). Потенциал десятки млн под TikTok/Shorts.
2. **Листиклы «N ошибок / привычек / лайфхаков» — стабильно виральны** (5 ошибок новичка 1.5М, 13 плохих привычек 1.5М, лайфхаки скутер 7.2М). Мы это умеем (кинетик-нумерация, как 051). ДЕЛАТЬ БОЛЬШЕ: «5 ошибок новичка на квадро», «5 привычек, убивающих китайский мотоцикл», «7 лайфхаков для мото в городе», «лайфхаки для эндуро».
3. **Долговечность** «китайский мото спустя 2 года» (632К) — снимает страх, ведёт на гарантию. Отдельный ролик.
ПЛАН: листиклы ошибок/лайфхаков — в ротацию чаще (польза-бакет); долговечность-ролик; звук-формат когда будет аудио от клиента. VS-сравнение (анализ #1) держим.
