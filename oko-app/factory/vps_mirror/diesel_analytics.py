...
lines += ["🎵 TikTok: постинг идёт (A 2365299 · B 2363201); статистику Hooppy по API не отдаёт."]
lines += ["📸 Instagram: ОБЕ сессии протухли (diesel_official1 + diesel_kitay) — залипли на saved-login экране, нужен РУЧНОЙ вход Даниэля. Постинг IG в простое; YouTube+TikTok идут штатно."]
report = "\n".join(lines)
