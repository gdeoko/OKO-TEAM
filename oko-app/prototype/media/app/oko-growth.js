...
'   stroke-width:7 — потому что весь спрайт нарисован в viewBox 0 0 100 100.',
'   При width:16px модуль сжимается в 6.25 раза: 7 даёт привычные 1.1 px,',
'   а двойка превращалась в 0.32 px и иконка пропадала с экрана. Ядро (svg.i)',
'   держит ровно 7 — берём то же число, чтобы толщина совпадала с интерфейсом. */',
...
'.okg-step.done .okg-step-n .okg-i{ width:13px; height:13px; stroke-width:9; }',
