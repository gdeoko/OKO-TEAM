...
const MODULES = [
  { id:'wallet',         area:'Кошелёк / лицевой счёт, пополнение, вывод' },
  { id:'channels',       area:'Платные каналы и курсы, управление, комиссия' },
  { id:'games',          area:'Рулетка OKO и игры: призы, билеты, вовлечение' },
  { id:'stories-plus',   area:'Сторис: редактор, просмотры, реакции' },
  { id:'profile-social', area:'Профиль, соцграф, подписки, пустые состояния' },
  { id:'registration',   area:'Регистрация и онбординг: первое впечатление, оффер' },
];
