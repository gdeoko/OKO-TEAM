...
/* ---------- УРОК 1: Мышление и старт ---------- */
{
  ...
  sub:'3:40 · видео + слайды + тест + игра',
  dur:'3:40',
...
/* ---------- УРОК 3: Визуал и лента ---------- */
{
  ...
  sub:'4:00 · видео + слайды + тест + игра',
  dur:'4:00',
...
const AC_COURSE = [].concat(MEDIA_LESSONS, AC_COURSE_REELS, MARKETING_LESSONS, AC_COURSE_AI);
...
const AC_COURSES = [
  { id:'media', title:'Медийность', tag:'Направление · база',
    sub:'6 уроков · личный бренд, упаковка, контент · сертификат за направление',
    from:0, count:6, free:true, minTier:'PRO', price:0, author:'OKO · по методологии ХЛБ',
    outcomes:[
  ...
  { id:'marketing', title:'Маркетинг', tag:'Направление · продажи',
    sub:'3 урока · копирайтинг, продающий пост, хуки и триггеры · сертификат за направление',
    from:6, count:3, free:false, minTier:'PRO', price:2900, author:'OKO · по методологии ХЛБ',
    outcomes:[
  ...
  { id:'ai', title:'Нейросети', tag:'Направление · практика',
    ...
    from:9, count:5, free:false, minTier:'PRO', price:2900, author:'Команда OKO',
    outcomes:[
