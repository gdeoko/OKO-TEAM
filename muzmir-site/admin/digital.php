...
// ПОИСК ИЩЕТ ПО ВСЕМУ, А НЕ ТОЛЬКО ПО ОЧЕРЕДИ.
// Раздел открывается на «В очереди», и это правильно для работы. Но когда
// оргкомитет ищет конкретного участника («что мы ей отправили?»), фильтр молча
// прятал всё отправленное, и выходило, будто наградных материалов нет вовсе.
// Есть запрос — показываем все записи, если фильтр не задан явно.
