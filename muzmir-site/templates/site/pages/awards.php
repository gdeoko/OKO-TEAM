...
<section class="section">
  <div class="container">
    ...
    <div class="grid grid-3" style="margin-top:40px">
      ...
      <div class="card reveal">
        <h3>Доставка</h3>
        <p style="color:var(--text-dim);margin:0">Оригиналы наградного материала отправляются почтой. Стоимость доставки оплачивается отдельно заказчиком при получении (наложенный платёж).</p>
      </div>
      <div class="card reveal">
        <h3>Возврат посылки</h3>
