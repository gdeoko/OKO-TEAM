  ...
  <div class="container" style="max-width:440px">
    <div class="card reveal auth-shell" style="padding:34px 26px 30px">
      ...
      <div class="auth-social" style="display:grid;gap:12px">
        ...
        <?php endif; ?>
        <?php if ($googleReady): ?>
          <a class="auth-btn auth-btn--google" href="<?= url('/api/v1/oauth_google') ?>" rel="nofollow"><?= $svgGoogle ?><span>Продолжить с Google</span></a>
        <?php else: ?>
          <button type="button" class="auth-btn auth-btn--google" disabled style="opacity:.55;cursor:not-allowed"><?= $svgGoogle ?><span>Google (скоро)</span></button>
        <?php endif; ?>
      </div>
