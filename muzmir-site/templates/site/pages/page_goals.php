...
$tasks = [
    ...
    'Выдача наградных материалов и обеспечение возможности проверки их подлинности.',
];
...
<section class="section">
  <div class="container" style="max-width:920px">
    <div class="section-head reveal">
      ...
      <div class="gold-rule"></div>
      <p>Полный цикл проведения конкурса - от разработки положения до выдачи наградных материалов.</p>
    </div>
...
<section class="section">
  <div class="container" style="max-width:920px">
    ...
    <p class="reveal" style="text-align:center;color:var(--muted);font-size:.9rem;margin-top:26px;max-width:760px;margin-left:auto;margin-right:auto">
      Дополнительно соблюдаются требования Федерального закона от 27.07.2006 №152-ФЗ «О персональных данных» и профильного законодательства о защите информации.
    </p>
  </div>
</section>
<?php
