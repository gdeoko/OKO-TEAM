...
if ($about === '') {
    $about = 'Культурного центра «Музыкальный Мир» проводит ' . mb_strtolower($typeLabel)
        ...
        . 'Работы принимаются по видеозаписи, конкурс проходит по номинациям и возрастным категориям. Итоги оценивает компетентное жюри, наградные материалы направляются на электронную почту участника.';
}
...
$platformsNo = ['Иностранные соцсети (заблокированы в РФ)','Иностранные видеохостинги','Иностранные мессенджеры'];
    ...
    <div class="comp-tabs reveal" id="compTabs">
      ...
      <div class="comp-panel is-active" data-panel="about">
        ...
        <div class="comp-callout">
          ...
          <p>Формат конкурса - дистанционный. Работы принимаются по видеозаписи, итоги подводит компетентное жюри, наградные материалы направляются на электронную почту участника.</p>
        </div>
      </div>
      ...
      <div class="comp-panel" data-panel="participation">
        ...
        <p>По итогам конкурса участники получают наградные материалы в электронном виде. Оригиналы дипломов, кубки, медали и статуэтки можно заказать дополнительно.</p>
        <?php if ($awards): ?>
          <div class="scroll-x">
      ...
      <div class="comp-panel" data-panel="results">
        <?php if ($results): ?>
          <p>Итоги конкурса. Наградные материалы направлены на электронную почту участников.</p>
        ...
        <?php else: ?>
          <p style="color:var(--muted)">Результаты будут опубликованы после завершения оценки жюри и направлены участникам на электронную почту. Проверить подлинность полученного диплома можно на странице <a href="<?= url('/verify') ?>">проверки наградных материалов</a>.</p>
        <?php endif; ?>
      </div>
    </div>
...
render_page($c['name'], $content, [
    'active'   => '/competitions',
    'meta'     => $metaBase !== '' ? $metaBase : ($typeLabel . ' «' . $c['name'] . '» - Культурного центра «Музыкальный Мир». Подача заявки онлайн, номинации, возрастные категории, наградные материалы.'),
