...
render_page('Результаты конкурсов', $content, ['active' => '/results', 'meta' => 'Итоги конкурсов Культурного центра «Музыкальный Мир»: лауреаты и дипломанты. Проверка подлинности дипломов по номеру.']);
