...
.rv-reply{margin-top:14px;padding:14px 16px;background:var(--gold-soft);border:1px solid var(--glass-brd);border-radius:var(--radius-sm)}
.rv-reply b{display:block;margin-bottom:4px;font-size:.85rem;color:var(--gold-2)}
.rv-pager{display:flex;justify-content:center;gap:8px;margin-top:36px;flex-wrap:wrap}
.rv-pager a{padding:9px 16px;border-radius:999px;border:1.5px solid var(--gold);font-weight:700;font-size:.92rem;color:var(--text)}
      ...
      <div class="grid grid-3">
        <?php foreach ($reviews as $r): ?>
          <div class="card reveal">
            ...
            <p style="font-family:var(--ff-serif);font-size:1.05rem;margin-top:10px;color:var(--text)">«<?= h($r['text']) ?>»</p>
