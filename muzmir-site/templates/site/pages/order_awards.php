  ...
  <div class="container" style="max-width:760px">
    ...
    <form id="awardsOrderForm" class="card reveal order-card" novalidate data-app-result="<?= h($appResultLock) ?>">
      ...
      <div class="field">
        ...
        <?php /* Подпись общая на все конкурсы, поэтому обещать здесь бесплатный
                 диплом нельзя: он бесплатен только там, где входит в оргвзнос.
                 В бесплатном конкурсе наградные материалы платные, и цена видна
                 рядом — обещание над ценником выглядит обманом. */ ?>
        <span class="hint">Можно отметить несколько позиций. В конкурсах с оргвзносом электронные основной и дополнительный дипломы входят в участие и приходят сами.</span>
