...
<section class="section">
  <div class="container">
    <div class="section-head reveal">
      ...
      <p class="ms-lead">Международные и всероссийские многожанровые конкурсы и фестивали Культурного центра
        «Музыкальный Мир» проводятся <strong>при информационной поддержке Министерств культуры и образования
        субъектов Российской Федерации и портала «PRO.Культура.РФ»</strong>. Ниже собраны письма и
        благодарности региональных ведомств - официальное подтверждение статуса и значимости проводимых
        мероприятий.</p>
    </div>
