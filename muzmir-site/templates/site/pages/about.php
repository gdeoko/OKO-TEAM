...
/* ── Данные страницы ── */
$timeline = [
    ['2020', 'Основание центра', 'Культурный центр «Музыкальный Мир» создан по инициативе Ильясова Альберта Ильясовича - заслуженного артиста России, заслуженного деятеля культуры, лауреата международных конкурсов.'],
...
$leaders = [
    [
        ...
        ['Основатель Культурного центра (2020)', 'Заслуженный артист России', 'Заслуженный деятель культуры', 'Лауреат международных конкурсов', 'Преподаватель эстрадного вокала, руководитель ВИА'],
    ],
    [
    ...
    <div class="grid grid-2" style="align-items:start">
      <div class="card reveal">
        ...
        <div class="req-row">
          ...
          <div>
            <div class="req-k">Генеральный директор</div>
            <div class="req-v">Ильясов Альберт Ильясович</div>
          </div>
        </div>
        <div class="req-row">
...
render_page('О нас', $content, ['active' => '/about', 'meta' => 'О Культурном центре «Музыкальный Мир»: история с 2020 года, миссия, статистика, руководство (генеральный директор Ильясов А.И., председатель Оргкомитета Галиулин Д.Д.), компетентное жюри, партнёры и реквизиты.']);
