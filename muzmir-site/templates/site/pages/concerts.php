...
render_page('Онлайн-концерты', $content, ['active' => '/concerts', 'meta' => 'Онлайн-концерты Культурного центра «Музыкальный Мир»: записи гала-концертов и творческих вечеров лауреатов конкурсов.']);
