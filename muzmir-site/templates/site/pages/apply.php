      ...
      <form class="card apply-card" id="applyForm" novalidate autocomplete="on">
        ...
        <section class="astep active" data-step="comp">
          <div class="astep-head">
            ...
            ?>
            <p style="color:var(--muted);font-size:.88rem;margin:6px 0 0">Отметьте один или несколько — оплатите одним чеком.<?= $__cost !== '' ? ' ' . h($__cost) . ', включая электронные основной и дополнительные дипломы.' : '' ?></p>
          </div>
