...
<table role="presentation" cellpadding="0" cellspacing="0" width="100%"
  ...
  <tr>
    <td style="padding:7px 14px;color:#6B7699;white-space:nowrap;vertical-align:top;width:1%;"><?= h((string) $k) ?></td>
    <td style="padding:7px 14px;color:#1D2B55;font-weight:600;"><?= h((string) $v) ?></td>
  </tr>
  <?php endforeach; ?>
</table>
<?php endif; ?>
