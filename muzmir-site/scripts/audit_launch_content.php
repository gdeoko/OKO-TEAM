 ...
 *      найден /vip (кнопка «Элитный клуб» вела в никуда во всех письмах запуска).
...
foreach (['konkurs' => 'launch_mail (открытие, вся база)', 'vip' => 'campaign_vip (Элитный клуб)'] as $ctype => $label) {
    $subj = ''; $body = '';
