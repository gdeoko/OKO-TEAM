...
/* Необязательный 2-й аргумент — принудительный движок бланка (v1=30.08 / v2=01.09),
 * чтобы собрать образец на нужной базе, не трогая живой выбор в БД. */
$engOverride = strtolower(trim((string) ($argv[2] ?? '')));
if ($engOverride === 'v1' || $engOverride === 'v2') { $c['diploma_engine'] = $engOverride; }
