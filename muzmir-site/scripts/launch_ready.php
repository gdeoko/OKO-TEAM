...
// Отдельных волн Элитного клуба и кабинета быть не должно: письмо одно, объединённое.
$extra = array_filter($jobs, fn($j) => in_array($j['wave'], ['campaign_vip', 'campaign_kabinet'], true));
$ok(!$extra, 'нет отдельных волн Элитного клуба и кабинета (письмо объединённое)', $extra ? count($extra) . ' лишних' : '');
