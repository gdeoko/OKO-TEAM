 ...
 *   1. срок отправки результата — 5 рабочих дней от подачи, участнику Элитного клуба 3;
...
/* ── 2. Элитный клуб: три рабочих дня ────────────────────────────────────────── */
echo "\n2. УЧАСТНИК ЭЛИТНОГО КЛУБА — ТРИ РАБОЧИХ ДНЯ\n";
...
if ($vip) {
    ...
    $check('Элитный клуб получает результат раньше обычного участника', $r2['send_at'] < $r1['send_at'], $r2['send_at'] . ' против ' . $r1['send_at']);
} else {
