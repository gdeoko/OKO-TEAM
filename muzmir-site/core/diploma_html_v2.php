...
(function(){
  ...
  function fitOptical(){
    ...
    /* ЗАДАННЫЙ ШАГ — ЭТО ПОТОЛОК, А НЕ ПРИКАЗ.
       При fixed_gap ставим ровно этот просвет, но сперва проверяем, что данные
       не подходят к подписям ближе RESERVE. Заявка бывает длинной (коллектив,
       длинное название учреждения, несколько педагогов) — там ровные 5 мм не
       помещаются физически, и без проверки строки наезжали бы на подписи.
