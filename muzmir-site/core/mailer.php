...
function mail_pool_names(string $pool): array {
    ...
    return match ($pool) {
        ...
        'awards'   => ['nagradi', 'kc', 'unisender-kc'],   // наградной, резерв — почта центра
        'official' => ['kc', 'unisender-kc'],              // обращения в ведомства: тот же адрес
        'news'     => ['unisender-kc'],                    // разовые новости и уведомления сайта
        default    => ['kc', 'nagradi', 'unisender-kc'],   // личные письма: свой адрес, любой путь
    };
}
