<?php
/**
 * ДОМЕНЫ, КОТОРЫЕ РЕЖУТ ПИСЬМА ЧЕРЕЗ СЕРВИС РАССЫЛОК. ТОЛЬКО НАБЛЮДЕНИЕ.
 *
 * Маршрут писем этот список НЕ меняет: массовые рассылки идут через оплаченный
 * сервис и только с рассылочных ящиков news@ и novosti@ (правило владельца).
 * Список нужен, чтобы видеть, куда письма не доходят и о чём говорить с
 * поддержкой почтовых служб, а не чтобы разводить письма по разным каналам.
 *
 *
