    ...
    try {
        ...
        if ($type === 'thanks') {
            ...
            $bless = 'Культурный центр «Музыкальный Мир» и оргкомитет международного многожанрового '
                ...
                // Формулировка та же, что в основном шаблоне: конкурсы центра
                // всероссийские, международный статус в документе не обещаем.
                . 'искусству, посредством участия в мероприятиях культуры и искусства. Желаем Вам '
