...
$body = 'Оргкомитет Культурного центра «Музыкальный Мир» выражает искреннюю благодарность '
      . ($named ? 'за личное участие и ' : '')
      . 'за информационную поддержку всероссийских творческих конкурсов, оказанную '
      . '<b>' . htmlspecialchars($org, ENT_QUOTES) . '</b>, и за содействие в распространении '
      . 'сведений о конкурсах среди учреждений культуры, образования и дополнительного '
      . 'образования детей'
...
<div class="sheet">
  ...
  <div class="content">
    ...
    $under = $named ? trim($role . ($role !== '' && $org !== '' ? ' · ' : '') . $org) : $region;
    if ($under !== ''): ?>
