...
/* РЕКВИЗИТЫ ДЛЯ ПЛАТЁЖНОГО СЕРВИСА — ТОЛЬКО ПО ПРЯМОЙ ССЫЛКЕ.
 *
 * ЮKassa просит страницу с банковскими реквизитами. Участникам она не нужна, а
 * на странице личный счёт получателя — поэтому её нет ни в меню, ни в подвале,
 * ни в карте сайта, и поисковикам она закрыта заголовком (плюс строка в
 * robots.txt). Открывается у того, кому дали адрес. */
if ($route === '/payment-rec') {
