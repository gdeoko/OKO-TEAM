 ...
 *
 * Отдельного письма о Элитном клубе здесь больше нет: приглашение в клуб идёт третьим
...
try {
    ...
    // отправил бы ОТДЕЛЬНОЕ письмо о Элитном клубе и пост в ВК — ровно поверх объединённого
    ...
    /* ============ 4. РАССЫЛКА ОБ ЭЛИТНОМ КЛУБЕ — УБРАНА НАВСЕГДА ============
