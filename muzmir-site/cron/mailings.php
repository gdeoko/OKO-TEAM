<?php
/**
 * Единый почасовой крон маркетинговых рассылок КЦ «Музыкальный Мир»:
...
try {
    ...
    if ($launch) {
        $many = count($launch) > 1;
        $subject = $many
            ? 'Открыт приём заявок на новые конкурсы - КЦ «Музыкальный Мир»'
    ...
    if ($hour === 10) {
        ...
        if ($soon) {
            $many = count($soon) > 1;
            $subject = $many
                ? 'Осталось 3 дня до конца приёма заявок - КЦ «Музыкальный Мир»'
    ...
    if ($hour === 9) {
        ...
        if ($last) {
            $many = count($last) > 1;
            $subject = $many
                ? 'Последний день приёма заявок - КЦ «Музыкальный Мир»'
