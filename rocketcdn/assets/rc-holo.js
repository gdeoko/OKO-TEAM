...
function declutter() {
  ...
  for (i = 0; i < list.length; i++) {
    ...
    /* И обратный случай: у левого края переброшенная карточка уходит
       за границу той же стороной. Если слева места нет, а справа
       есть - возвращаем карточку вправо. Иначе на узком экране
       подпись у самого края кадра просто исчезала. */
