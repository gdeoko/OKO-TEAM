...
Sound.prototype.двигатель = function (ctx, выход) {
  ...
  /* Было 0.5. Новых слоёв стало больше, и замер показал прибавку в
     2.5 дБ на выходе двигателя - при том, что прибавка эта пришлась
     на верх, который ухо считает громким охотнее всего. Задача была
     сделать звук достовернее, а не громче, поэтому общий уровень
     подрезан ровно на столько, на сколько он вырос. */
  eg.gain.value = 0.42;
