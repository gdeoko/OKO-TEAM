...
function screenTex(T, rec, tiny) {
  ...
  /* Плотность подобрана по чтению: при .38-.48 мокрые блики стены
     просвечивали сквозь буквы и текст читался с усилием. При .72-.80
     экран остаётся стеклом по краям, а строки лежат на спокойном
     фоне. */
  var gr = x.createLinearGradient(0, 0, W * 0.4, H);
  gr.addColorStop(0, "rgba(13,33,53,.80)");
  gr.addColorStop(0.55, "rgba(8,25,42,.72)");
  gr.addColorStop(1, "rgba(5,15,28,.82)");
