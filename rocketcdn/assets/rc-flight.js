...
function панельD(W, H, fovDeg) {
  ...
  try {
    ...
    /* Панель лежит на стене, а кресло отодвигается вглубь на
       R - D. Совсем прижимать кресло к центру нельзя: комната
       перестанет читаться комнатой, а подъезду не останется хода.
       Полтора метра до стены - предел. */
    var Dмакс = 1.55;
