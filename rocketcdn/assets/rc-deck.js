...
function клавиша(c, w, h, k, сила, ru, наЭкране, кЭкрану) {
  ...
  var тесно = экрВыс < 46;
  var кегль = Math.max(9.5 * кД, h * (тесно ? 0.20 : 0.145));
  ...
  c.font = "700 " + кегль + "px Montserrat, system-ui, sans-serif";
  c.textAlign = "center";
  c.textBaseline = "alphabetic";
  ...
  c.fillText(имя, w / 2, h * (тесно ? 0.92 : 0.88));
