...
/* Одиннадцать команд: имя, подпись под иконкой, рисунок иконки.

   Порядок обязан посимвольно совпадать с physicalControlsFrame.nodes
   и deckFrame в rc-flight.js: подпись на плите берётся отсюда по
   номеру ниши. Они разошлись на две позиции и молчали об этом - на
   плите писалось «БЛИЖЕ», а нажатие сохраняло снимок. Меняешь тут -
   меняй и там, обоими списками сразу. */
var KEYS = [
