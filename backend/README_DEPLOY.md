...
> Ролик «как добраться» залей в корень с именем **`location.mp4`** (вертикальный 9:16) — он откроется в окне «Как добраться?» на главной. Адрес клуба: **Москва, Проспект Мира, дом 102с25** (живая карта Яндекса + кнопка «Проложить маршрут» уже встроены).
