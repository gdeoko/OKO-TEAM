/* ═══════════════════════════════════════════════════════════
   ВНИМАНИЕ: ЭТОТ ФАЙЛ НЕ ОБЩИЙ С СОСЕДНИМ САЙТОМ.

   Имя одно на два репозитория, а модули РАЗНЫЕ, и это сделано
   нарочно. У CDN пульт забирает к себе живые формы страницы
   (#leadForm, #cbForm) и закрепляет высоту раздела контактов, чтобы
   страница не укоротилась под ногами. У VPN форм нет ни одной: на
   rocketvpn.top нет ни одного поля ввода, весь разговор идёт в
   Телеграме, и те же две кнопки ведут в ботов.

   Скопировать файл от соседа значит молча вернуть чужое поведение:
   на VPN кнопки снова откроют пустую ячейку, на CDN формы перестанут
   переезжать. Ровно на этом уже обожглись с rc-cabin.js, где две
   копии разошлись на сто восемьдесят одну строку.

   Общие модули рубки (rc-cabin.js, rc-panel.js, rc-deck.js,
   rc-keys.js, rc-planets.js) держатся побайтно одинаковыми, и
   различия у них живут в параметрах вызова. Этот - не из них.
   ═══════════════════════════════════════════════════════════ */
/* ═══════════════════════════════════════════════════════════
