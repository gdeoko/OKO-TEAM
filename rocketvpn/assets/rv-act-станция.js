...
(function (g, d) {
  ...
  function построить(мир) {
    ...
    М.кладкаМат = new T.ShaderMaterial({
      uniforms: Object.assign({}, общие, {
        uOutline: { value: 0 },
        uKamen: { value: new T.Color(0x74767D) }, uTen: { value: new T.Color(0x343A4A) },
        uVerh: { value: new T.Color(0xA6ADBC) }, uNiz: { value: new T.Color(0x232838) },
  ...
  function тема(имя) {
    ...
    if (имя === "светлая") {
      ...
      у.uKamen.value.setHex(0x74767D); у.uTen.value.setHex(0x343A4A);
      у.uVerh.value.setHex(0xA6ADBC); у.uNiz.value.setHex(0x232838);
    }
  }
