  ...
  function писатьМатрицы(доля, t, dt, часы) {
    ...
    /* РАСПИСАНИЕ АКТА. Владелец сказал прямо: домик должен ПОСТОЯТЬ
       ...
       Акт растянут до 420 экранов высоты и поделён так:
         ...
         0.00-0.26  купол собирается из разлёта
         0.26-0.52  стоит целый, дышит, расступается под курсором
       ...
       Прежде сборка заканчивалась на 0.4, а раскрытие начиналось на
       0.72 - целым купол был ровно треть акта, и на снимках его в этом
       состоянии не оказалось вовсе. */
    var s0 = fit(доля, 0, 0.26, 1, 0);
    var s = 1 - Math.cos(s0 * Math.PI / 2);          /* sine.in */
    /* Раскрытие теперь не самостоятельный приём, а первый шаг перелёта:
       блоки снимаются с кладки наружу ровно тогда, когда начинают лететь
       в стену. Иначе купол сперва раскрывался, потом зачем-то стоял
       раскрытым, и только потом блоки трогались с места. */
