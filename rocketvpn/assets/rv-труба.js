  ...
  function фОбод(дешево) {
    return [
      ...
      /* СИЛА ИДЁТ ЦВЕТОМ, А НЕ ПРОЗРАЧНОСТЬЮ. Складывающий режим кладёт
         ...
         двойку, и даже с множителем 0.94 канал упирается в потолок
         кадра - выходит их белое. Тональной кривой в сборке нет вовсе
         (в rv-world.js ни toneMapping, ни ореола), поэтому всё, что
         выше единицы, просто срезается буфером. */
