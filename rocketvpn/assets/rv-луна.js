...
(function (g, d) {
  ...
  /* ── ДНЕВНАЯ ПАЛИТРА СЧИТАНА С ЖИВОГО igloo, А НЕ ПОДОБРАНА ────
     ...
     и середина. Это и есть «пересвечено»: не небо, а грунт.
  ...
  var Ф_ГРУНТ = [
    ...
    /* ── ОКНО СОЛНЦА ШИРЕ ДНЁМ ────────────────────────────────
       ...
       так, чтобы карта нормалей начала работать светом, а не только
       мелкой крупой.
  ...
  var Ф_ЗЕМЛЯ = [
    ...
    /* ── ДНЁМ ДИСК ВСЁ ЖЕ САДИТСЯ В НЕБО, НО ЧУТЬ-ЧУТЬ ─────────
       ...
       то есть почти нулём: на светлом кадре это не планета, а ДЫРА,
       вырезанная в небе, и глаз читает её как брак вывода.
