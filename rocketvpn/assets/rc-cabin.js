...
function build(T, opts) {
  ...
  (function () {
    ...
    /* Во сколько раз лицо секции крупнее кадра и вокруг какой точки
       холста оно растёт. Числа подобраны по снимкам обоих экранов. */
    var ЗУМ_ЛИЦА = 1.28, ОПОРА_X = 0.5, ОПОРА_Y = 0.38;
