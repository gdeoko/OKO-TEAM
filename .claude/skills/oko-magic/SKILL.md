...
8. **Озвучка (ролики, уроки, голосовой ИИ-агент, бот, VPS) — только скилл `/oko-voice`, бесплатно.** Бренд-голос **Silero `eugene`** (муж), премиум/клон — **XTTS-v2**. edge-tts и платные кредиты ElevenLabs/Higgsfield на озвучку НЕ использовать.
