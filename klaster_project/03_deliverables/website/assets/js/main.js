...
(function(){
  ...
  var KB=[
    ...
    {q:'Что с зоной КРТ?',a:'Объект вне зоны КРТ, снос не грозит. Эффект кластера работает уже сейчас: больше ста предприятий и тысяча рабочих мест на одной площадке.'},
